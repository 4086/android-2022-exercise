package com.example.roomaddex

import android.os.Bundle
import androidx.appcompat.app.AppCompatActivity
import com.example.roomaddex.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.addStudent.setOnClickListener {
            if (binding.editStudentId.text.isNotEmpty() && binding.editStudentId.text.toString().toInt() > 0) {
                val id = binding.editStudentId.text.toString().toInt()
